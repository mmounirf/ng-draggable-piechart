...
(function(){
    ...
    DraggablePiechart.prototype.defaults = {
        ...
        radius: 0.9,
            data: [
        { angle: -2, format: { color: "#de3832", label: 'Angular'}, collapsed: false },
        { angle: -1, format: { color: "#61dafb", label: 'React'}, collapsed: false },
        { angle: 0, format: { color: "#744cbc", label: 'Redux'}, collapsed: false },
        { angle: 1, format: { color: "#c6538c", label: 'SASS'}, collapsed: false },
        { angle: 2, format: { color: "#c2185b", label: 'RxJS'}, collapsed: false }],
        collapsing: false,
        minAngle: 0.1,
